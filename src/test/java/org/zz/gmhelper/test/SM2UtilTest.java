...
public class SM2UtilTest extends GMBaseTest {
  ...
  public void testSignAndVerify() {
    try {
      ...
      System.out.println(
          "Pri Hex:" + ByteUtils.toHexString(priKey.getD().toByteArray()).toUpperCase());
      System.out.println(
          "Pub X Hex:"
  ...
  public void testKeyPairEncoding() {
    try {
      ...
      FileUtil.writeFile("D:/ec.pkcs8.pri.pem", priKeyPkcs8Pem.getBytes(StandardCharsets.UTF_8));
      ...
      FileUtil.writeFile("D:/ec.x509.pub.pem", pubKeyX509Pem.getBytes(StandardCharsets.UTF_8));
