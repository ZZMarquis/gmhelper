...
public class SM2KeyExchangeUtil {
   ...
   */
  public static byte[] calculateKey(
      boolean initiator,
      int keyBits,
      ECPrivateKeyParameters selfStaticPriv,
      ECPrivateKeyParameters selfEphemeralPriv,
      byte[] selfId,
      ECPublicKeyParameters otherStaticPub,
      ECPublicKeyParameters otherEphemeralPub,
      byte[] otherId) {
   ...
   * @return
   */
  public static ExchangeResult calculateKeyWithConfirmation(
      boolean initiator,
      int keyBits,
    ...
    exch.init(
        new ParametersWithID(
            ...
            selfId));
    byte[][] result =
        exch.calculateKeyWithConfirmation(
            keyBits,
            confirmationTag,
            new ParametersWithID(
                new SM2KeyExchangePublicParameters(otherStaticPub, otherEphemeralPub), otherId));
